...
function APIexecRaposa() {
  ...
  function buscarCachorro() {
    let status = document.getElementById("status-raposa");
    let imagemCachorro = document.getElementById("foto-raposa-cachorro");
  ...
  return (
    <div className="raposa-container" id="card-raposa">
      ...
      <div className="imagens-container">
        <img
          id="foto-raposa-cachorro"
          alt="raposa ou cachorro"
